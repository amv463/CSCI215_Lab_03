function calculate() {
    ...
    // Todo: Perform conversion calculations here
       var poundsToKg = weight * 0.454;
       var inchesToM = height * 0.0254;
       var inchesToCm = height * 2.54;
    ...
    BSA = Math.sqrt((inchesToCm * poundsToKg) / 3600);
    // -------------------------------
    ...
    BMI = poundsToKg * Math.pow(inchesToM, 2);
